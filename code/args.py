...
def get_VAE_config():
    ...
    parser.add_argument('--g_lr', type=float, default=0.001, help='learning rate for G')
    parser.add_argument('--d_lr', type=float, default=0.001, help='learning rate for D')
    parser.add_argument('--p_lr', type=float, default=0.01, help='learning rate for Property')
    ...
    config.g_lr = config.d_lr = 1e-1
    config.model_save_step = 10
    config.batch_size = 5
    config.num_epochs = 100

    # For testing
    # config.mode = 'test'
    # config.saving_dir = '..\\exp_results\\VAE_test\\2023-06-04_10-46-07\\'
    # config.resume_epoch = 20
